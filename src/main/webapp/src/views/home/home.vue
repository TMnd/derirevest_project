<template>
  <b-container fluid>
      ...
      <div class="col-lg-6">
        <div class="homeFirstRow_section">
          <div class="input-group" style="margin-bottom: 10px;">
              <input type="text" class="form-control py-2" placeholder="Insira o codigo do produto..." id="product-search-input" v-model="searchInputValue" v-on:keyup.enter="searchProduct">
              <button id="product-search-input_clear" type="button" class="btn bg-transparent" v-show="showSearchResultClearButton" v-on:click="searchProductClear()" style="margin-left: -40px; z-index: 100;">
              ...
              <div v-show="this.checkAuthorization('DELIVERY_SEE_LIST')">
                ...
                >
                  <template v-slot:item="props">
                    <tr v-on:click="selectSearchProduct(props.item)">
                      <td class="icon">
    ...
    <b-row>
      <div class="col-lg-4">
        <transition name="fade">
          <div class="homeFirstRow_section" v-show="!focusSingleProduct">
            <div class="titleArea">
              <div style="width: 92%">
      ...
      <div class="col-lg-4">
        <transition name="fade">
          <div class="homeFirstRow_section" v-show="!focusSingleProduct">
            <div class="titleArea">
              <div style="width: 92%">
                <p class="h5 title">Faturas a vencer</p>
              </div>
              <div>
                <div>
<!--                  <actionButton inputIconShow="refresh" @buttonFunction="refreshDelivery"></actionButton>-->
